...
describe 'Charges API' do
  context 'POST /api/v1/charges' do
    it 'should create a charge with credit card' do
      ...
      payment_credit = Payment.create!(name: 'Dev Card',
                                       type_payment: 'credito', fee_percentage: '1.2', max_fee: '50', active: true, bank_code: '000')
    ...
    it 'should create a charge with boleto' do
      ...
      payment_method = PaymentMethod.create!(payment_id: payment_boleto.id,
                                             company_id: company.id, agency: '1234', bank_account: '8524-9')
      client = Client.create!(name: 'Matheus Oliveira', cpf: '12312312512')
      discount = Discount.create!(company_id: company.id,
                                  payment_method_id: payment_method.id, discount_percentage: 5)
  ...
  context 'GET /api/v1/charges/:charge_id/searches' do
    ...
    it 'search by payment method' do
      ...
      payment_boleto = Payment.create!(name: 'Banco Ximira',
                                       type_payment: 'boleto', fee_percentage: '1.1', max_fee: '30', active: true, bank_code: '987')
      payment_method1 = PaymentMethod.create!(payment_id: payment_credit.id,
                                              company_id: company.id, code: 'qweasdzxc123poi098lk')
      ...
      client2 = Client.create!(name: 'Gabriela Oliveira', cpf: '12312312512')
      client3 = Client.create!(name: 'Jucelino Oliveira', cpf: '12312312512')
      discount1 = Discount.create!(company_id: company.id,
                                   payment_method_id: payment_method1.id, discount_percentage: 5)
      discount2 = Discount.create!(company_id: company.id,
                                   payment_method_id: payment_method2.id, discount_percentage: 5)
